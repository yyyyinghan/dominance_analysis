...
#           DijS for unestablished dominance are set up as 0.5.
#############################################################################
  ...
  for (m in 1:p){
    for (n in 1:p){
      ...
      if(m == n){
        ...
        dm1[m,n] <-0.5 # equal dominance
      }else{
        dm1[m,n] <- 0.5 # unestablished dominance relationship
      }
    }
  }
...
write.xlsx(dat_list1, "/Users/ying/Desktop/Dissertation writing/Analysis results/pop_results/pop_da_comp.xlsx", rowNames = FALSE, overwrite = TRUE) 
write.xlsx(dat_list2, "/Users/ying/Desktop/Dissertation writing/Analysis results/pop_results/pop_da_cond.xlsx", rowNames = FALSE, overwrite = TRUE) 
write.xlsx(dat_list3, "/Users/ying/Desktop/Dissertation writing/Analysis results/pop_results/pop_da_gen.xlsx", rowNames = FALSE, overwrite = TRUE) 
write.xlsx(result_gd, "/Users/ying/Desktop/Dissertation writing/Analysis results/pop_results/pop_GD.xlsx", rowNames = FALSE, overwrite = TRUE) 
